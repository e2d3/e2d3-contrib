...
d3.json(baseUrl + "/jp013-tokyo.topojson", function(error, o) {              //wat
...
//      d.properties.data = data[d.properties.MOJI] || {};  //tyx
      d.properties.data = data[d.properties.N03_004] || {};  //tyx
    });
...
//    tooltipTitle.text(d.properties.prefecture+d.properties.city+d.properties.ward);   //tyx
      tooltipTitle.text(d.properties.PREF_NAME +' '+ d.properties.MOJI);					//tyx
      tooltipTitle.text(d.properties.PREF_NAME +' '+ d.properties.N03_004);					//tyx
