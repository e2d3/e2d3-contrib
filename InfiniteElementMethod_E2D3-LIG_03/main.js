...
function iniprocess(){
	...
	var colors =["#0000FF", "#FFFF00",  "#00FF00","#00FFFF", "#FF0000", "#FF00FF","#800000", "#808000",  "#008000","#008080", "#000080", "#800080","#000000", "#808080",  "#FF9900","#C0C0C0"];
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("　　　　　").attr("x", (c2[d]-25))
				.attr("y", -5).style("fill","grey");
	...
	function transitionPart(data, id, p){
		...
		mainbar.select(".barvalue").transition().duration(500)
			.attr("y",function(d){ return d.middle+5;}).text("");
