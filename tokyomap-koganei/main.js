...
//  .scale(Math.min(width, height) * 350.0)   //wat
  .center([139.55,35.73])                   //wat
  .scale(Math.min(width, height) * 725.0)   //wat
...
var placeName ='151202_koganei';               //wat
...
d3.json(baseUrl + "/151202_koganei.topojson", function(error, o) {              //wat
