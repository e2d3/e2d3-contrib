...
//フォントの機種依存問題があるため、google-fontを読み込んで
...
(function(d){
    ...
    link.setAttribute('href','http://fonts.googleapis.com/css?family=Open+Sans:400,300');
...
function update(data)
{
  ...
  d3.layout.cloud().size([width, height])
      .words(data.map(function(d){
        return {text: d.name, size: szScale(d.value), font: d.font};
      }))
      .padding(4)
